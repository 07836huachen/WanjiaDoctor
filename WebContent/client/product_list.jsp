...
<body class="main">
	...
	String context="http://localhost:8080/itcatstore";
					...
					<table cellspacing="0" class="listcontent">
						<tr>
							<td>
								<h1>医生目录</h1>
								<hr />
								<h1>${bean.category}</h1>&nbsp;&nbsp;&nbsp;&nbsp;共${bean.totalCount}个医生
								<hr />
										...
										<c:forEach items="${bean.ps}" var="p" varStatus="vs">
											<td>
												...
												<div class="divlisttitle">
													<a href="${pageContext.request.contextPath}/findProductById?id=${p.id}">医生姓名： ${p.name}<br />日收费：￥${p.price} </a>
												</div>
											</td>
										</c:forEach>
									</tr>
