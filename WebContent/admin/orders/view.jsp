...
<body>
	<table cellSpacing="1" cellPadding="5" width="100%" align="center"
		...
		<tr>
			<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">签约编号：</td>
		...
		<tr>
			<td align="center" bgColor="#f5fafe" class="ta_01">家庭用户：</td>
		...
		<tr>
			<td align="center" bgColor="#f5fafe" class="ta_01">服务地址：</td>
		...
		<tr>
			<td align="center" bgColor="#f5fafe" class="ta_01">签约时间：</td>
			<td class="ta_01" bgColor="#ffffff" colSpan="3">${order.ordertime}</td>
		</tr>
		<TR>
			<TD class="ta_01" align="center" bgColor="#f5fafe">签约家庭医生信息</TD>
			<TD class="ta_01" bgColor="#ffffff" colSpan="3">
				<table cellspacing="0" cellpadding="1" rules="all" bordercolor="gray" border="1" id="DataGrid1"
					style="BORDER-RIGHT: gray 1px solid; BORDER-TOP: gray 1px solid; BORDER-LEFT: gray 1px solid; WIDTH: 100%; WORD-BREAK: break-all; BORDER-BOTTOM: gray 1px solid; BORDER-COLLAPSE: collapse; BACKGROUND-COLOR: #f5fafe; WORD-WRAP: break-word">
					<tr style="FONT-WEIGHT: bold; FONT-SIZE: 12pt; HEIGHT: 25px; BACKGROUND-COLOR: #afd1f3">
						<td align="center" width="7%">序号</td>
						<td width="8%" align="center">图像</td>
						<td align="center" width="18%">医生编号</td>
						<td align="center" width="10%">医生姓名</td>
						<td align="center" width="10%">收费价格</td>
						<td width="7%" align="center">签约天数</td>
						<td width="7%" align="center">专科</td>
						<td width="31%" align="center">个人描述</td>
					</tr>
