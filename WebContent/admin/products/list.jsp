	...
	<form id="Form1" name="Form1"
		...
		<table cellSpacing="1" cellPadding="0" width="100%" align="center" bgColor="#f5fafe" border="0">
			<TBODY>
				...
				<tr>
					<td>
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							<tr>
								<td height="22" align="center" bgColor="#f5fafe" class="ta_01">医生编号：</td>
								<td class="ta_01" bgColor="#ffffff">
									<input type="text" name="id" size="15" value="" id="Form1_userName" class="bg" />
								</td>
								<td height="22" align="center" bgColor="#f5fafe" class="ta_01">专科：</td>
								<td class="ta_01" bgColor="#ffffff">
							...
							<tr>
								<td height="22" align="center" bgColor="#f5fafe" class="ta_01">医生姓名：</td>
								<td class="ta_01" bgColor="#ffffff">
									<input type="text" name="name" size="15" value="" id="Form1_userName" class="bg" />
								</td>
								<td height="22" align="center" bgColor="#f5fafe" class="ta_01">收费价格区间(元)：</td>
								<td class="ta_01" bgColor="#ffffff">
				...
				<tr>
					<td class="ta_01" align="center" bgColor="#afd1f3"><strong>家 庭 医 生 列 表</strong>
					</TD>
				</tr>
				<tr>
					...
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr style="FONT-WEIGHT: bold; FONT-SIZE: 12pt; HEIGHT: 25px; BACKGROUND-COLOR: #afd1f3">
								<td align="center" width="24%">医生编号</td>
								<td align="center" width="18%">医生姓名</td>
								<td align="center" width="9%">收费价格</td>
								<td align="center" width="9%">可签约天数</td>
								<td width="8%" align="center">专科</td>
